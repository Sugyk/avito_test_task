...
func (s *Service) PullRequestCreate(pr *models.PullRequest) (models.PullRequest, error) {
...
func (s *Service) PullRequestReassign(prID string, oldUserID string) (models.PullRequest, string, error) {
